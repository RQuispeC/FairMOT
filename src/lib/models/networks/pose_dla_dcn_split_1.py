...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.joint_shared_layer = nn.Sequential(
        ...
        fill_fc_weights(self.joint_shared_layer)
    ...
    def forward(self, x):
        ...
        shared_repr = self.joint_shared_layer(y[-1])
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
  "base model using simple convolutions to create share, deid and detection heads"
