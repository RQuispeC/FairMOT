...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.detect_bn = nn.BatchNorm2d(channels[self.first_level], momentum=BN_MOMENTUM)
        self.reid_bn = nn.BatchNorm2d(channels[self.first_level], momentum=BN_MOMENTUM)
...
def get_pose_net(num_layers, heads, head_conv=256, down_ratio=4):
  ...
  + (bn)**2 for reid and detection branches (to have task specific bn)
  """
